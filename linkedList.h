...
public:
  ...
  // The *initializer list* on line 11 is a concise way of
  // assigning the actual parameters of the constructor to
  // the data members of the new node. The constructor is
